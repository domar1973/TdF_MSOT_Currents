	...
	common /qbfcdat/ qbfcid
     ...
     &                                         'T')
      ...
      ierr=nf_put_var1_double (ncid, varid, 1, D_wetdry)
      if (ierr.ne.nf_noerr) then
        write(stdout,2) 'xl', ncname(1:lstr)
        goto 99
      endif
