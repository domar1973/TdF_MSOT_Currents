     ...
     &     angle, phase, omega_loc, ramp, cff
      real
     &        Cangle(Istr-2:Iend+2,Jstr-2:Jend+2),
     &        Cphase(Istr-2:Iend+2,Jstr-2:Jend+2),
     &        Sangle(Istr-2:Iend+2,Jstr-2:Jend+2),
     &        Sphase(Istr-2:Iend+2,Jstr-2:Jend+2),
     &        Etide(Istr-2:Iend+2,Jstr-2:Jend+2),
     &        Utide(Istr-2:Iend+2,Jstr-2:Jend+2),
     &        Vtide(Istr-2:Iend+2,Jstr-2:Jend+2)
      INTEGER*4, dimension(4) :: borde_merid
      INTEGER*4, dimension(4) :: borde_zonal
      integer*4 :: ix, jx
